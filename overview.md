...
* [产品简介](ai/uai-inference/intro)
    ...
    * [产品架构](ai/uai-inference/intro/structure)
...
* [快速上手](ai/uai-inference/set-up)
    * [快速上手:TF-Mnist案例](ai/uai-inference/set-up/tf-mnist)
...
* [实践场景](ai/uai-inference/tutorial)
