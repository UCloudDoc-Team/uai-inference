...
​    }
  ...
  * **mxnet.model\_name&num\_epoch**(可选） 对应了MnistModel中self.model\_name和self.num\_epoch，用于给Inference 类对象传递模型名字参数，MXNetAiUcloudModel会根据model\_dir, model\_name和num\_epoch自动生成mxnet的模型文件路径，详情请参见[链接](https://github.com/ucloud/uai-sdk/blob/master/uai/arch/mxnet_model.py)。
...
请参见[镜像基础包](uai-inference/guide/mxnet/packages)中MXNet基础镜像列表。
